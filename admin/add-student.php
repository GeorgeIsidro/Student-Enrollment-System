...
<div class="col-sm-6">
	...
	<form enctype="multipart/form-data" method="POST" action="">
		<div class="form-group">
	  	...
	  	<div class="form-group">
		    <label for="roll">Student ID Number</label>
	  	...
	  	<div class="form-group">
		    ...
		    <input name="pcontact" type="text" class="form-control" id="pcontact" pattern="09[0-9]{9}" value="<?= isset($pcontact)? $pcontact: '' ; ?>" placeholder="09........." required="">
	  	</div>
	  	<div class="form-group">
